...
function State() {
    return (
        <div className="text-left">
            <h1 className="flex items-center font-bold mb-4"><span className="text-4xl">Stats</span> <span className="text-2xl"><FaEthereum/> </span> </h1>
            ...
            <div className="pt-3 pb-3 border border-gray-300 mr-3 shadow-2xl rounded-lg md:w-1/2 h-52">
