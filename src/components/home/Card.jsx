...
import { FaArrowUp, FaEthereum } from 'react-icons/fa';
...
function Card() {
    return (
        ...
        <div className='grid sm:grid-cols-1 md:grid-cols-2 items-center'>
            ...
            <div>
            <p className='flex items-center text-3xl'><span className='mr-3'><FaEthereum/></span><span>$ZOMI</span></p>
        </div>
        ...
        <div className='mt-5'>
            ...
            <div>
            <p className='flex items-center text-3xl'><span className='mr-3'><FaEthereum/></span><span>$ZLP</span></p>
        </div>
